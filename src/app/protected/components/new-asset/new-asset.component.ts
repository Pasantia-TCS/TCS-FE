...
export class NewAssetComponent implements OnInit {
  ...
  nuevoActivoForm: FormGroup = this.fb.group({
    ...
    serie: ['', [Validators.required, Validators.pattern('[a-zA-Z0-9]*$'), Validators.maxLength(20)]],
    codigo_barras: ['', [Validators.required, Validators.pattern('^[0-9]*$'), Validators.maxLength(20)]],
